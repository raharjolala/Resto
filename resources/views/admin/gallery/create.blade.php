...
<style>
    ...
    * {
    ...
    #imagePreviewContainer p::before {
        content: '\f03e';
                ...
                <div class="col-md-8">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" 
                                  ...
                                  name="description" 
                                  rows="4"
                                  placeholder="Jelaskan tentang foto ini...">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="mb-3">
                        <label for="image_url" class="form-label">
                            ...
                            URL Gambar <span class="text-danger">*</span>
                        </label>
                        <input type="url" 
                        ...
                        <div id="imagePreviewContainer" class="mt-3 text-center" style="display: none;">
                            <p class="mb-2 fw-bold">Preview Gambar</p>
