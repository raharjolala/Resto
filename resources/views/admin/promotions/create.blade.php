...
<style>
    ...
    .btn-admin-outline:hover::before {
        width: 300px;
        height: 300px;
    }
    ...
    hr {
        ...
        border: none;
        height: 2px;
        background: linear-gradient(90deg, transparent, var(--accent-red), var(--deep-red), var(--accent-red), transparent);
    }
            ...
            <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('title') is-invalid @enderror" 
                                       id="title" name="title" value="{{ old('title') }}" required placeholder="Masukkan judul promosi...">
                                @error('title')
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                          id="description" name="description" rows="4" required placeholder="Jelaskan detail promosi...">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control @error('current_price') is-invalid @enderror" 
                                           id="current_price" name="current_price" min="0" value="{{ old('current_price') }}" required placeholder="0">
                                </div>
                                @error('current_price')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control @error('old_price') is-invalid @enderror" 
                                           id="old_price" name="old_price" min="0" value="{{ old('old_price') }}" placeholder="0">
                                </div>
                                <small class="text-muted"><i class="fas fa-info-circle"></i> Kosongkan jika tidak ada diskon</small>
                                @error('old_price')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('badge_text') is-invalid @enderror" 
                                       id="badge_text" name="badge_text" value="{{ old('badge_text', 'PROMO SPESIAL') }}" required placeholder="Contoh: PROMO SPESIAL">
                                <small class="text-muted"><i class="fas fa-tag"></i> Contoh: PROMO SPESIAL, PAKET KELUARGA, BUY 1 GET 1</small>
                                @error('badge_text')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('button_text') is-invalid @enderror" 
                                       id="button_text" name="button_text" value="{{ old('button_text', 'Pesan Sekarang') }}" required placeholder="Contoh: Pesan Sekarang">
                                <small class="text-muted"><i class="fas fa-hand-pointer"></i> Contoh: Pesan Sekarang, Lihat Paket, Lihat Menu</small>
                                @error('button_text')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('sort_order') is-invalid @enderror" 
                                       id="sort_order" name="sort_order" min="0" value="{{ old('sort_order', 0) }}" placeholder="0">
                                <small class="text-muted"><i class="fas fa-sort-numeric-down"></i> Semakin kecil angka, semakin awal tampil</small>
                                @error('sort_order')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="col-md-4">
                    <div class="form-group mb-3">
                        ...
                        <small class="text-muted"><i class="fas fa-image"></i> Masukkan URL gambar dari Unsplash atau sumber lain</small>
                        @error('image_url')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
    ...
    function updatePreview() {
        ...
        if (url) {
            ...
            previewImage.onerror = function() {
                previewImage.classList.remove('loading');
                previewImage.src = 'https://via.placeholder.com/400x200?text=Gambar+Tidak+Ditemukan';
            };
        } else {
    ...
    function validatePrices() {
        if (oldPrice.value && currentPrice.value) {
            if (parseFloat(oldPrice.value) <= parseFloat(currentPrice.value)) {
                ...
                oldPrice.classList.add('is-invalid');
            } else {
                oldPrice.setCustomValidity('');
                oldPrice.classList.remove('is-invalid');
            }
        } else {
            oldPrice.setCustomValidity('');
            oldPrice.classList.remove('is-invalid');
